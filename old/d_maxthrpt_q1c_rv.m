...
%ini t
step=0.03;
load('d_maxthrpt_q1c_ca.mat');
load('d_maxthrpt_q1c_cb.mat');
tot_iter=0;
for ic=1:m
    Q=Q_all(ic,:)';
    for t04=opt3_time4(ic)-opt3_time3(ic)/3:step:(opt3_time4(ic)+opt3_time3(ic)/3-step)
        for t01=opt3_time1(ic)-opt3_time3(ic)/3:step:(opt3_time1(ic)+opt3_time3(ic)/3-step)
            for t02=opt3_time2(ic)-opt3_time3(ic)/3:step:(opt3_time2(ic)+opt3_time3(ic)/3-step)
                t03=1-t01-t02-t04;
                t0=[t01;t02;t03;t04];
                ...
                if(maxthrpt3(ic)<sumthrp1)
                    ...
                    save d_maxthrpt_q1c_ca.mat ic Q_all opt3_time1 opt3_time2 opt3_time3 opt3_time4 opt3_t0 maxthrpt3 step
                end                
                tot_iter=tot_iter+1;
            end
        end
...
for ic=1:m
    Q=Q_all(ic,:)';
    for t04=opt4_time4(ic)-opt4_time3(ic)/3:step:(opt4_time4(ic)+opt4_time3(ic)/3-step)
        for t01=opt4_time1(ic)-opt4_time3(ic)/3:step:(opt4_time1(ic)+opt4_time3(ic)/3-step)
            for t02=opt4_time2(ic)-opt4_time3(ic)/3:step:(opt4_time2(ic)+opt4_time3(ic)/3-step)
                t03=1-t01-t02-t04;
                t0=[t01;t02;t03;t04];
                ...
                if(maxthrpt4(ic)<sumthrp2)
                    ...
                    save d_maxthrpt_q1c_cb.mat ic Q_all opt4_time1 opt4_time2 opt4_time3 opt4_time4 opt4_t0 maxthrpt4 step
                end
                tot_iter=tot_iter+1;
            end
        end
