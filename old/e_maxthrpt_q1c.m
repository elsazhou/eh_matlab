    ...
    for t01=0.1:0.1:0.8
        for t02=0.1:0.1:0.9-t01
            ...
            if(maxthrpt5(ic)<sumthrp1)
                ...
                save e_maxthrpt_q1c_ca.mat ic Q_all opt5_time1 opt5_time2 opt5_time3 opt5_t0 maxthrpt5
            end
            ...
            if(maxthrpt6(ic)<sumthrp2)
                ...
                save e_maxthrpt_q1c_cb.mat ic Q_all opt6_time1 opt6_time2 opt6_time3 opt6_t0 maxthrpt6
            end
            tot_iter=tot_iter+1;
        end
    end
