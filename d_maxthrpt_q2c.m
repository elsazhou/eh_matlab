        ...
        for t01=0.2:0.1:0.7-t04
            for t02=0.2:0.1:0.9-t01-t04
                ...
                if(maxthrpt3(ic)<sumthrp1)
                    ...
                    save d_maxthrpt_q2c_ca.mat ic Q_all opt3_time1 opt3_time2 opt3_time3 opt3_time4 opt3_t0 maxthrpt3
                end                
                tot_iter=tot_iter+1;
            end
        end
        ...
        for t01=0.2:0.1:0.7-t04
            for t02=0.1:0.1:0.2
                ...
                if(maxthrpt4(ic)<sumthrp2)
                    ...
                    save d_maxthrpt_q2c_cb.mat ic Q_all opt4_time1 opt4_time2 opt4_time3 opt4_time4 opt4_t0 maxthrpt4 
                end
                tot_iter=tot_iter+1;
            end
        end
