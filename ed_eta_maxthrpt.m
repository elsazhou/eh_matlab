     ...
     for t04=0.1:0.1:0.5
        for t01=0.2:0.1:(0.8-t04)
            for t02=0.2:0.1:(0.9-t01-t04)
                t03=1-t01-t02-t04;
                t0=[t01;t02;t03;t04];
                [process_t1,Pka1,tka1,iter1,throuput1]=ehp2_ca(a,t0,Q,eta(ic),d,sigma,epsi);
                ...
                if(maxthrpt1(ic)<sumthrp1)
                    ...
                    save ed_maxthrpt_eta_ca.mat ic Q opt1_time1 opt1_time2 opt1_time3 opt1_time4 opt1_t0 maxthrpt1 opt1_rho
                end              
                tot_iter=tot_iter+1;
            end
        end
        ...
        for t01=0.2:0.1:(0.7-t04)
            for t02=0.02:0.02:0.08
                ...
                if(maxthrpt2(ic)<sumthrp2)
                    ...
                    save ed_maxthrpt_eta_cb.mat ic Q opt2_time1 opt2_time2 opt2_time3 opt2_time4 opt2_t0 maxthrpt2 opt2_rho
                end
                tot_iter=tot_iter+1;
            end
        end
