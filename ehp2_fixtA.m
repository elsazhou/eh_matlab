...
function [thrp,power]=ehp2_fixtA(t,h,sigma,eta,Q)
t1=t(1);
t2=t(2);
t3=t(3);
t4=t(4);
...
cvx_begin quiet
    ...
    subject to 
        ...
        t2*log(1+(P(2)-P(4))*r3)>=B;
        Q1*t4>=P(1)*t1;
        Q2*t4+(eta*h(3)*P(1)+Q2)*t1>=P(2)*t2;
        Q1*t4-P(1)*t1+Q1*(t1+t2)+eta*h(3)*P(4)*t2>=P(3)*t3;       
        P(1)>=0;
        P(2)>=0;
        P(3)>=0;
        P(4)>=0;
