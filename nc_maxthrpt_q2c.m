...
%step=0.02;
%ini t
load('nc_maxthrpt_q2c_ca.mat');
load('nc_maxthrpt_q2c_cb.mat');
step=0.005;
tot_iter=0;
for ic=9:m
    Q=Q_all(ic,:)';
    for t01=(opt7_time1(ic)-0.1):step:(opt7_time1(ic)+opt7_time3(ic)/2-0.01)
        for t03=0.005:step:(opt7_time3(ic)+0.1)
            ...
            if(maxthrpt7(ic)<sumthrp1)
                ...
                save nc_maxthrpt_q2c_ca.mat ic Q_all opt7_time1 opt7_time2 opt7_time3 opt7_t0 maxthrpt7 step
            end
            tot_iter=tot_iter+1;
        end
    end
...
for ic=1:m
    Q=Q_all(ic,:)';
    for t01=(opt8_time1(ic)-opt8_time3(ic)/2):step:(opt8_time1(ic)+opt8_time3(ic)/2-0.01)
        for t03=0.005:step:(opt8_time3(ic)+0.1)
            ...
            if(maxthrpt8(ic)<sumthrp2)
                ...
                save nc_maxthrpt_q2c_cb.mat ic Q_all opt8_time1 opt8_time2 opt8_time3 opt8_t0 maxthrpt8 step
            end
            tot_iter=tot_iter+1;
        end
    end
